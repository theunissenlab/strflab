...
function tfrep = make_tfrep(typeName, params)
    ...
    switch typeName
        ...
        case 'stft'                
            params = check_fields(params, {'fband', 'nstd', 'high_freq', 'low_freq', 'log', 'refpow', 'dbnoise'},...
                'Must specify params.%s for stft!\n', {125, 6, 8000, 250, 1, 0, 80});
